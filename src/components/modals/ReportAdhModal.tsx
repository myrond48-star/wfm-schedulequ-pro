    ...
    <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center p-4 z-[20000]">
      <div className="bg-white p-6 rounded-2xl w-full max-w-[400px] shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-2.5">
          ...
          <button className="px-5 py-2.5 bg-sky-500 text-white border-none font-bold rounded-xl hover:bg-sky-600 transition-colors shadow-lg shadow-sky-200 w-full sm:w-auto" onClick={generateReportAdh}>📥 Export to Excel</button>
        </div>
      </div>
    </div>
  );
